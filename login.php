...
$connectionInfo = array( "CharacterSet" => "UTF-8", "UID" => "crmdb11", "PWD" => "Ikworx?" );
$conn1 = sqlsrv_connect( 'den1.mssql8.gear.host', $connectionInfo );
...
if ( isset( $_POST[ 'submit' ] ) ) {
	...
	if ( $stmt === false ) {
		...
		header('Location:http://crmtesting123.gearhostpreview.com/users/login/'.$user.'/'.$pass);
...
<head>
	...
	<style type="text/css">
		...
		.login-block {
			...
			background: -webkit-linear-gradient(to bottom, #d3d376, #cccc00);
			/* Chrome 10-25, Safari 5.1-6 */
			background: linear-gradient(to bottom, #d3d376, #cccc00);
